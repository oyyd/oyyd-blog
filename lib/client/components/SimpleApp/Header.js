...
var BG_IMG_HEIGHT = 1000;
var BG_LINE = '/static/img/app/header-bg/bg-line.png';
var BG_IMGS = ['/static/img/app/header-bg/1.png', '/static/img/app/header-bg/2.png'];
...
var Header = function (_Component) {
  ...
  function Header(props) {
    ...
    _this.bgImg = BG_IMGS[Math.round(Math.random(1))];
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'header' },
        _react2.default.createElement(_PerspectiveImg2.default, { src: this.bgImg,
